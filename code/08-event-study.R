...
for (t in -12:12) {
   a <- c(t)
  base_event_study[paste0("D_", a)] <-
    (base_event_study$dados_evento == t) * (base_event_study$ano_sisu/base_event_study$ano_sisu)
